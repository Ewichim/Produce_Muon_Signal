...
ax[0,1].hist2d(truthsig['eta'], xSizesSig, bins=[30, np.arange(0,9,1)], cmap='Blues')
ax[0,1].set_title("Signal", fontsize=15)
ax[1,1].hist2d(truthsig['eta'], ySizesSig, bins=[30, np.arange(0,14,1)], cmap='Blues')
...
ax.hist2d(truthsig['number_eh_pairs'], truthsig['pt'], bins=30, cmap='Blues')
