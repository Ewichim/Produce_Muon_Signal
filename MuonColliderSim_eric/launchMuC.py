...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--outDir", help="Output directory", default="/local/d1/smartpixML/bigData/Simulation_Output_Signal")
    parser.add_argument("-j", "--ncpu", help="Number of cores to use", default=40, type=int)
    parser.add_argument("-p", "--pixelAVdir", help="pixelAV directory", default="/home/youeric/PixelSim2/pixelav")
    ...
    for folder in os.listdir(tracklist_folder):
        ...
        for tracklist in os.listdir(folder):
            ...
            # pixelAV = [pixelAVdir, "./bin/ppixelav2_list_trkpy_n_2f.exe", "1", tracklist, f"{outFileName}.out", f"{outFileName}_seed"]
